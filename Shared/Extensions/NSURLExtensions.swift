...
private func loadEntriesFromDisk() -> TLDEntryMap? {
    if let data = String.contentsOfFileWithResourceName("effective_tld_names", ofType: "dat", fromBundle: Bundle(identifier: "org.baumhoto.Shared")!, encoding: String.Encoding.utf8, error: nil) {
